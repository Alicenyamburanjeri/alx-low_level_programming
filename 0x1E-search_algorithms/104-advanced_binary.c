...
int binary_search_rec(int *array, int value,
			    size_t low, size_t high);

/**
 * binary_search_rec - helper to `advanced_binary`, recursively searches
			    ...
			    size_t low, size_t high)
{
	...
	{
		if (array[mid] < value)
			return (binary_search_rec(array, value,
							mid + 1, high));
		if (array[mid] >= value)
			return (binary_search_rec(array, value,
							low, mid));
...
int advanced_binary(int *array, size_t size, int value)
{
	...
	return (binary_search_rec(array, value, low, high));
}
